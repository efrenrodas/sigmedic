                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('sintomas.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('sintomas.destroy',$sintoma->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('sintomas.edit',$sintoma->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
