            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="fechaNaciemiento" class="col-md-4 col-form-label text-md-end">{{ __('Fecha de Nacimiento') }}</label>

                            <div class="col-md-6">
                                <input id="fechaNaciemiento" type="date" class="form-control @error('fechaNaciemiento') is-invalid @enderror" name="fechaNaciemiento" value="{{ old('fechaNaciemiento') }}" required autocomplete="fechaNaciemiento" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ciudadResidencia" type="text" class="form-control @error('ciudadResidencia') is-invalid @enderror" name="ciudadResidencia" value="{{ old('ciudadResidencia') }}" required autocomplete="ciudadResidencia" autofocus>
